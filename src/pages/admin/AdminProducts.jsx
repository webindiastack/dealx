    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-brand-600 text-white font-bold text-xs shadow-md hover:bg-slate-900 transition-all flex items-center gap-2 self-start sm:self-auto"
        >
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200/90 shadow-sm flex items-center justify-between">
        ...
        <span className="text-xs font-mono text-slate-500 font-bold hidden sm:inline">
          Total Items: <strong className="text-slate-900">{products.length}</strong>
        </span>
      </div>
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredProducts.map((p) => (
                <tr key={p.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-3.5 px-4">
                    <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-slate-900 text-white border border-slate-800">
                      {p.category}
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono font-extrabold text-brand-600">
                  ...
                  <td className="py-3.5 px-4">
                    {p.featured ? (
                      <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-slate-900 text-white border border-slate-800">
                        Featured
                      </span>
                    ) : (
                  ...
                  <td className="py-3.5 px-4 text-right space-x-2">
                    <button
                      ...
                      className="p-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-700 hover:text-slate-900 hover:border-brand-500 transition-colors"
                      title="Edit Product"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-500 hover:text-rose-600 hover:border-rose-500 transition-colors"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-pop-in">
          <div className="w-full max-w-xl bg-white rounded-3xl border border-slate-200 shadow-2xl p-6 space-y-4 max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-brand-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-brand-500"
                />
              </div>
              ...
              <div className="pt-4 border-t border-slate-100 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-xl bg-brand-600 text-white text-xs font-bold hover:bg-brand-700 shadow-md"
                >
